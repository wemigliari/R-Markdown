---
title: "Global Fire Data"
author: "Migliari, W. (2021)"
...
test1%>%layout(annotations = list(
 list(x = 0.03 , y = 1.05, text = "Annual fire C emissions (Tg C year)", showarrow = F, xref='paper', yref='paper'),
 list(x = 0.88 , y = 1.05, text = "Savanna fires C emissions (Tg C year)", showarrow = F, xref='paper', yref='paper'))
)
...
test2%>%layout(annotations = list(
 list(x = 0.03 , y = 1.05, text = "Boreal forest fires C emissions (Tg C year)", showarrow = F, xref='paper', yref='paper'),
 list(x = 0.88 , y = 1.05, text = "Temperate forest fires C emissions (Tg C year)", showarrow = F, xref='paper', yref='paper'))
)
...
test3%>%layout(annotations = list(
 list(x = 0.03 , y = 1.05, text = "Tropical deforestation and degradation", showarrow = F, xref='paper', yref='paper'),
 list(x = 0.88 , y = 1.05, text = "Peat Fires C emissions (Tg C year)", showarrow = F, xref='paper', yref='paper'))
)
